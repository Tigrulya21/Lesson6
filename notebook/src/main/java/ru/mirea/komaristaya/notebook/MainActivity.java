package ru.mirea.komaristaya.notebook;
...
import ru.mirea.komaristaya.notebook.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void writeFileToExternalStorage()	{
        ...
        try	{
            ...
            output.write(binding.Quotation.getText().toString());
    ...
    public void readFileFromExternalStorage()	{
        ...
        try	{
            ...
            binding.Quotation.setText(lines.toString());
        }	catch (Exception e)	{
